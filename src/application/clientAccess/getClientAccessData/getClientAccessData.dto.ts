...
export type InputClientAccessDTO = Pick<ClientAccessData, "clientID" | "ip" | "timestamp">
...
export const validadeInputClientAccessDTO = (input: InputClientAccessDTO) => {
  ...
  if (typeof timestamp != "number" || timestamp < 0) errors.push("Timestamp must be positive a number");
